...
## Status
ACTIVE — PUBLIC and requalified with the replacement identity in v3.1.3 from `d489654`. The GUI-only default tray session, configurable close-to-tray behavior, bounded Windows/macOS hardware tooltip, and unchanged tray-free TUI contract passed the Windows synthetic/immutable-prior update and uninstall matrix plus signed macOS Intel/Apple Silicon installation lifecycles in the same release. The sole remaining acceptance item is the operator-visible Windows notification-area confirmation of the live tooltip, glyph, and tray Quit action.

## Activity
- 2026-07-25 03:40 — v3.1.3 requalified the combined #ctt/#n7k release: Windows producer 30150538506 passed fresh and prior-version update/uninstall routes with the tray assets owned by the exact manifest, macOS 30150538503 passed both native signed-PKG lifecycles, and Qualify/Publish 30151050783 published and proved the public Cargo/managed lifecycle; manual Windows notification-area observation remains open (agent: codex)
