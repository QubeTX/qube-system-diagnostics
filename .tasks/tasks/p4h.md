...
ACTIVE, owner Codex. The operator chose to fix GUI latency first, preserving the 100 ms gate. Windows updater/discovery and shell fixes remain in PR #11; public/local 4.0.0 and website PR #18 stay unchanged until qualification. The next cycle measures input dispatch, frame wait and automation publication on native runners to distinguish the causes of the Intel/musl delays. No timing waiver or root cause is assumed.
