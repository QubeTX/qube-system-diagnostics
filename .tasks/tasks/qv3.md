...
## Status
Queued behind #gux and #cpl. The feature branch is frozen at pushed head `8aaeef7b1b3d009ba5d18f0e14e6cf57d20a09d0` plus an uncommitted two-file Windows cleanup correction. Exact-head ordinary CI `29892152552`, release planning `29892152578`, and macOS preflight `29892224525` are green; Windows installer run `29892216141` failed on the known pre-fix managed-uninstall prompt. Release remains blocked by the operator-reported minute-old scroll lag, the prematurely exited/empty two-hour soak and frame/input evidence, an exact-head Windows installer replay after the cleanup correction, Makira app-embedding license evidence or an authorized open-font replacement, signed/notarized candidate qualification, provenance, immutable publication, and fresh public-byte/site/physical acceptance. No merge, tag, crate publication, or release is authorized by the current evidence.
