...
## Active
- [ ] **Replace the Windows MSI placeholder license and release the correction** - EULA and full Windows lifecycle verified in PR #14; publication held on unchanged CI timing gates, release-only exception decision pending (owner codex) #eul
