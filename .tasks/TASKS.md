...
## Active
- [ ] **Replace the Windows MSI placeholder license and release the correction** - PolyForm Noncommercial 1.0.0 in both MSI editions; 4.0.2 candidate, performance work excluded by operator (owner codex) #eul
